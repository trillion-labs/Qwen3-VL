...
if [ -z "${OMPI_COMM_WORLD_SIZE-}" ] && [ -z "${PMI_SIZE-}" ]; then
  PROCS=${PROCS:-64}
  HOSTS=${HOSTS:-"sub2:8,sub3:8,sub4:8,sub5:8,sub6:8,sub7:8,sub8:8,sub9:8"}
  MASTER_ADDR=${MASTER_ADDR:-sub4}
  MASTER_PORT=${MASTER_PORT:-23477}
...
DEFAULT_MASTER_PORT="23477"    # choose an open fixed port for all ranks
...
# Datasets
datasets=android_in_the_zoo,android_control_case1,android_control_case2,android_control_case3,android_control_case4,amex,arpo_sft,ui_vision,ui_vision_4mp,gui_r1,gui_odyssey,jedi_amex_l1,jedi_amex_l2,jedi_amex_l3,jedi_android_control_v2,jedi_coat_v2,jedi_component_final_1_5m_cleaned_split,jedi_component_library_snap_icon_data_description,jedi_component_library_snap_icon_data_grounding,jedi_component_v1_130k,jedi_doc_data_new,jedi_doc_scroll_data_new,jedi_ethercalc_v1,jedi_guiact_web_multi,jedi_guiact_web_single_v2,jedi_guide_si_10k_v2,jedi_guienv,jedi_icon_v0222_description,jedi_icon_v0222_grounding,android_in_the_wild,jedi_ios_app_data,jedi_layout200k_grounding,jedi_layout200k,jedi_layout400k_claude_grounding,jedi_layout400k_claude,jedi_mac_app_data,jedi_mind2web_train,jedi_omniact,jedi_os_layout_v1_grounding,jedi_os_layout_v1,jedi_ricoig16k,jedi_ricosca,jedi_seeclick_mi_ui_tars_cleaned,jedi_seeclick_ui_tars_cleaned_fixed,jedi_slide_v1_17k,jedi_training_data_icon_grounded_merged,jedi_training_data_icon_pure_color_background,jedi_ui_refexp,jedi_webui350k,jedi_widget_captioning,jedi_aitw_l1,jedi_aitw_l2,jedi_aitw_l3

#,jedi_refusal_component_final_1_5m,jedi_refusal_component_library_snap_icon_data_grounding,jedi_refusal_component_v1_130k,jedi_refusal_guienv,jedi_refusal_icon_v0222_grounding,jedi_refusal_ricosca,jedi_refusal_seeclick_mi_ui_tars_cleaned,jedi_refusal_seeclick_ui_tars_cleaned_fixed,jedi_refusal_training_data_icon_grounded_merged,

# datasets=android_control_case1,arpo_sft,ui_vision,ui_vision_4mp,gui_r1,gui_odyssey,jedi_amex_l1,jedi_amex_l2,jedi_amex_l3,jedi_android_control_v2,jedi_component_final_1_5m_cleaned_split,jedi_component_library_snap_icon_data_description,jedi_component_library_snap_icon_data_grounding,jedi_component_v1_130k,jedi_doc_data_new,jedi_doc_scroll_data_new,jedi_ethercalc_v1,jedi_guiact_web_multi,jedi_guiact_web_single_v2,jedi_guide_si_10k_v2,jedi_guienv,jedi_icon_v0222_description,jedi_icon_v0222_grounding,jedi_ios_app_data,jedi_layout200k_grounding,jedi_layout200k,jedi_layout400k_claude_grounding,jedi_layout400k_claude,jedi_mac_app_data,jedi_mind2web_train,jedi_omniact,jedi_os_layout_v1_grounding,jedi_os_layout_v1,jedi_refusal_component_final_1_5m,jedi_refusal_component_library_snap_icon_data_grounding,jedi_refusal_component_v1_130k,jedi_refusal_guienv,jedi_refusal_icon_v0222_grounding,jedi_refusal_ricosca,jedi_refusal_seeclick_mi_ui_tars_cleaned,jedi_refusal_seeclick_ui_tars_cleaned_fixed,jedi_refusal_training_data_icon_grounded_merged,jedi_ricoig16k,jedi_ricosca,jedi_seeclick_ui_tars_cleaned_fixed,jedi_slide_v1_17k,jedi_training_data_icon_grounded_merged,jedi_training_data_icon_pure_color_background,jedi_ui_refexp,jedi_webui350k,jedi_widget_captioning,jedi_aitw_l1,jedi_aitw_l2,jedi_aitw_l3


data_name="200k_samples_all"
# Logging / output
run_name="qwen2_5vl-${data_name}"
