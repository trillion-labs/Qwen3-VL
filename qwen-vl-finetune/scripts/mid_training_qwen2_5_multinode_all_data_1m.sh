...
if [ -z "${OMPI_COMM_WORLD_SIZE-}" ] && [ -z "${PMI_SIZE-}" ]; then
  ...
  MASTER_ADDR=${MASTER_ADDR:-sub2}
  MASTER_PORT=${MASTER_PORT:-23900}
...
############################################
DEFAULT_MASTER_ADDR="sub2"     # main node
DEFAULT_MASTER_PORT="23900"    # choose an open fixed port for all ranks
...
# Datasets
datasets=android_in_the_zoo,android_control_case1_1m,android_control_case2_1m,android_control_case3_1m,android_control_case4_1m,amex_1m,ui_vision_1m,ui_vision_4mp_1m,gui_r1_1m,gui_odyssey_1m,jedi_amex_l1_1m,jedi_amex_l2_1m,jedi_amex_l3_1m,jedi_android_control_v2_1m,jedi_coat_v2_1m,jedi_component_final_1_5m_cleaned_split_1m,jedi_component_library_snap_icon_data_description_1m,jedi_component_library_snap_icon_data_grounding_1m,jedi_component_v1_130k_1m,jedi_doc_data_new_1m,jedi_doc_scroll_data_new_1m,jedi_ethercalc_v1_1m,jedi_guiact_web_multi_1m,jedi_guiact_web_single_v2_1m,jedi_guide_si_10k_v2_1m,jedi_guienv_1m,jedi_icon_v0222_description_1m,jedi_icon_v0222_grounding_1m,android_in_the_wild_1m,jedi_ios_app_data_1m,jedi_layout200k_grounding_1m,jedi_layout200k_1m,jedi_layout400k_claude_grounding_1m,jedi_layout400k_claude_1m,jedi_mac_app_data_1m,jedi_mind2web_train_1m,jedi_omniact_1m,jedi_os_layout_v1_grounding_1m,jedi_os_layout_v1_1m,jedi_refusal_component_final_1_5m_1m,jedi_refusal_component_library_snap_icon_data_grounding_1m,jedi_refusal_component_v1_130k_1m,jedi_refusal_guienv_1m,jedi_refusal_icon_v0222_grounding_1m,jedi_refusal_ricosca_1m,jedi_refusal_seeclick_mi_ui_tars_cleaned_1m,jedi_refusal_seeclick_ui_tars_cleaned_fixed_1m,jedi_refusal_training_data_icon_grounded_merged_1m,jedi_ricoig16k_1m,jedi_ricosca_1m,jedi_seeclick_mi_ui_tars_cleaned_1m,jedi_seeclick_ui_tars_cleaned_fixed_1m,jedi_slide_v1_17k_1m,jedi_training_data_icon_grounded_merged_1m,jedi_training_data_icon_pure_color_background_1m,jedi_ui_refexp_1m,jedi_webui350k_1m,jedi_widget_captioning_1m,jedi_aitw_l1_1m,jedi_aitw_l2_1m,jedi_aitw_l3_1m


data_name="mfm-v0d-1m"
# Logging / output
run_name="${data_name}"
